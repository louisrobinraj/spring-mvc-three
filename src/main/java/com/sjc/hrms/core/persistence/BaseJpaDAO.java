...
public abstract class BaseJpaDAO<EntityType> implements JpaDAO<EntityType> {
	...
	public List<EntityType> executeCriteriaQuery(CriteriaQuery<EntityType> criteriaQuery) {
		List<EntityType> resultList = em.createQuery(criteriaQuery).getResultList();
		return resultList;
	}

	public List<String> executeQueryForStringResult(CriteriaQuery<String> criteriaQuery) {
